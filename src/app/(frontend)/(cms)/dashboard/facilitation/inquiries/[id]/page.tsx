...
export default async function FacilitationInquiryDetailPage({ params }: RouteParams) {
  const { id } = await params
  const inquiry = await getInquiryById('facilitation', id)
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <InquiryDetailCard inquiry={inquiry} serviceArea="facilitation" />
        </CardContent>
      </Card>
    </div>
  )
